...
public class NewsPageElements {
    ...
    public static ViewInteraction thirdNews = onView(withIndex(withId(R.id.view_news_item_image_view), 0)); // с помощью утилиты находим 1ую новости в списке
    public static ViewInteraction thirdNewsDescriptionControlPanel = onView(withIndex(withId(R.id.news_item_description_text_view), 2)); // с помощью утилиты находим описание в 3ей новости в списке
    public static ViewInteraction listForSwipe = onView(withId(R.id.news_control_panel_swipe_to_refresh)); // свайпаем список новостей
    ...
    public static ViewInteraction editSecondNews = onView(withIndex(withId(R.id.edit_news_item_image_view), 1)); // кнопка редактирования 2ой новости
    ...
    public static ViewInteraction titleFirstNews2 = onView(withIndex(withId(R.id.news_item_title_text_view), 0)); // с помощью утилиты находим 1ую новость
    public static ViewInteraction titleFirstNews3 = onView(withIndex(withId(R.id.news_item_title_text_view), 0)); // с помощью утилиты находим 1ую новость

...
public class OurMissionPageTest {
    ...
    public void OpenOurMission() {
        ...
        onView(withId(R.id.our_mission_image_button)).perform(click()); // находим иконку для выхода и кликаем по ней
    ...
    public void ViewSecondQuote() {
        ...
        onView(withIndex(withId(R.id.our_mission_item_description_text_view), 1)).check(matches(isDisplayed())); // ожидаем появления описания 2ой цитаты
    }
